...
public class DropDownMenu extends LinearLayout {
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        boolean b = false;
        if (mOnTabCreat != null) {
            b = mOnTabCreat.onTabCreat(tabMenuView, tab, i);
    ...
    public interface OnTabCreat {
        boolean onTabCreat(LinearLayout parent, TextView view, int index);
    }

    private OnTabCreat mOnTabCreat;

    public void setOnTabCreat(OnTabCreat onTabCreat) {
        mOnTabCreat = onTabCreat;
    }
}
